...
#kropeczki z czasami pobran segmentow
#przewidywanie tcp
#klient w cpp
#przygotowanie scenariuszy
#strategia sciagania filmu w punktach
...
if __name__ == '__main__':
    ...
    #Bandwidth data
    bandlist, bandlistplot = readBandwidth("/home/bursant/eclipse_workspace/MastersSimulation/src/bandwidth4")
    
    #Bandwidth plot
    plotBandwidth(bandlistplot, ax1)

    #Representation data
    delta, fx, reps = readRepresentations("/home/bursant/eclipse_workspace/MastersSimulation/src/representation1", segments)
    fy = []
